...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-brand-red text-white shadow-[0_2px_6px_rgba(200,32,47,0.22)] hover:bg-brand-red-deep hover:-translate-y-px",
        primary:
          "bg-primary text-primary-foreground shadow-sm hover:opacity-90 hover:-translate-y-px",
        secondary:
          "border border-border bg-background text-foreground hover:bg-brand-navy-soft hover:text-brand-navy",
